...
if [[ $netstack == "6" ]]; then
    ...
    if [[ $warp_version == "3" ]]; then
        wget -N https://raw.githubusercontent.com/fscarmen/warp/main/warp-go.sh && chmod +x warp-go.sh
        bash warp-go.sh
    elif [[ $warp_version == "2" ]]; then
        wget -N https://raw.githubusercontent.com/fscarmen/warp/main/menu.sh && chmod +x menu.sh
        bash menu.sh
    else
        # bash <(curl -L git.io/warp.sh) 4
        wget -N https://raw.githubusercontent.com/P3TERX/warp.sh/main/warp.sh && chmod +x warp.sh
        bash warp.sh 4
    fi
