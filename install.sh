...
if [[ $netstack == "6" ]]; then
    ...
    if [[ $warp_version == "3" ]]; then
        curl -L https://raw.githubusercontent.com/fscarmen/warp/main/warp-go.sh -o ./warp-go.sh && chmod +x warp-go.sh && bash warp-go.sh
    elif [[ $warp_version == "2" ]]; then
        curl -L https://raw.githubusercontent.com/fscarmen/warp/main/menu.sh -o ./menu.sh && chmod +x menu.sh && bash menu.sh
    else
        # bash <(curl -L git.io/warp.sh) 4
        curl -L https://raw.githubusercontent.com/P3TERX/warp.sh/main/warp.sh -o ./warp.sh && chmod +x warp.sh && bash warp.sh 4
    fi
...
# 如果是 IPv4 小鸡，用 WARP 创建 IPv6 出站
    ...
    if [[ $warp_version == "3" ]]; then
        ...
        curl -L https://raw.githubusercontent.com/P3TERX/warp.sh/main/warp.sh -o ./warp.sh && chmod +x warp.sh && bash warp.sh 6
    fi
